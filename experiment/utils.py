...
def update_elements(ElementArrayStim, condition_settings, this_phase, elem_positions, nElements,
    ...
    ElementArrayStim.nElements = nElements

    print(ElementArrayStim.nElements)
    ...
    ElementArrayStim.setOris(ori_arr)
    ...
    ElementArrayStim.setColors(element_color, colorSpace='rgb')
